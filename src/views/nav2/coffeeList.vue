    ...
    <section>
        ...
        <template>
            <el-table :data="goodsList" highlight-current-row v-loading="loading" style="width: 100%;">
                ...
                <el-table-column prop="goodsPriceSmall" label="小杯价格" width="120" sortable>
                </el-table-column>
                <el-table-column prop="goodsPriceBetween" label="中杯价格" width="120" sortable>
                </el-table-column>
                <el-table-column prop="goodsPriceBig" label="大杯价格" width="120" sortable>
                </el-table-column>
